...
# 3.2.
# Squared error for Hitchiker's estimator is (mu - 42)^2

n = 5
mu = seq(40,44,length.out=100)

plot(mu, rep(10/n,100), type="l", ylim=c(0,4), lwd=2.5, ylab = "Squared error") # For sigma2 = 1
lines(mu, rep(1/n,100), col="red", ylim=c(0,4), lwd=2.5) # For sigma2 = 1
lines(mu, (mu-42)^2, col="blue", lwd=2.5)
legend(x=41,y=4,c("Sample mean (sigma^2=10)","Sample mean (sigma^2=1)","Hitchhiker's Estimator"), 
...
# 4.2 Estimate from training data
...
# 4.4 Empirical vs predicted probabilities
...
# 4.5 Empirical negative log-likelihood
