...
# Model contains 6 predictors, but five of them are different from BIC
# Only PLAS is in common between the two models.
...
# glmnet says we should prefer the lasso model in this case, which does indeed
# predict onto future data more effectively.